...
public class FindMaxMin<T extends Comparable<T>> {
    ...
    public static void main(String[] args) {
        ...
        FindMaxMin<String> findmaxstring = new FindMaxMin<String>(str1, str2, str3);
        ...
        str2 = "orange";
        str3 = "banana";
        System.out.println("Test Case 2 (String): ");
        findmaxstring = new FindMaxMin<String>(str1, str2, str3);
        findmaxstring.testMaximum();
        ...
        str2 = "apple";
        str3 = "orange";
        System.out.println("Test Case 3 (String): ");
        findmaxstring = new FindMaxMin<String>(str1, str2, str3);
        findmaxstring.testMaximum();
    }
